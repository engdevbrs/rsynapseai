...
import { Briefcase, GraduationCap, Award, Users, Linkedin } from "lucide-react"
...
export default function Team() {
  ...
  return (
    <section
      id="team"
      className="relative py-20 lg:py-32 bg-futuristic-gradient overflow-hidden"
    >
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <FadeIn delay={0.2} className="text-center mb-16">
          ...
          >
            <h2
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-text-primary"
              style={{ marginBottom: 0 }}
            >
              NUESTRO
              <span className="block text-gradient-subtitle">EQUIPO</span>
            </h2>
            <div
              className="h-1 w-24 bg-gradient-to-r from-blue-primary to-cyan-accent mx-auto rounded-full"
              style={{ marginTop: 0 }}
            />
            ...
            <div className="space-y-6">
              ...
              <div className="lg:col-span-2 relative z-10">
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-4 -right-4 w-20 h-20 bg-gradient-to-br from-cyan-accent to-blue-primary rounded-full flex items-center justify-center z-30 p-6">
              ...
              <div className="lg:col-span-3 space-y-6 relative z-10">
                  {/* Mobile: 2 Cards Layout, Desktop: Single Column */}
                  <div className="grid md:grid-cols-2 lg:grid-cols-1 gap-6">
                    {/* Card 1: Personal Information */}
                    <FadeIn delay={0.5} direction="right">
                      <div className="card-futuristic p-6 rounded-3xl">
                {/* Name and Title */}
                        <div className="mb-6">
                          <h3
                ...
                {/* Bio */}
                    ...
                    {/* Card 2: Credentials and Contact */}
                ...
                {/* Credentials */}
                        <div>
                          <h4
                            ...
                            style={{
                              backgroundImage:
                                "linear-gradient(90deg, #00FFFF 0%, #3B82F6 35%, #A855F7 70%, #EC4899 100%)",
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {ceo.credentials.map((credential, index) => {
                              const colors = [
                                ...
                                {
                                  bg: "from-pink-500/20 to-red-500/10",
                        ...
                        <motion.div
                          ...
                          whileHover={{ scale: 1.02 }}
                                ...
                                >
                                  ...
                                  <div
                                    className={`relative flex-shrink-0 w-12 h-12 bg-gradient-to-br ${colorScheme.icon} rounded-xl flex items-center justify-center hover:scale-110 transition-transform duration-300 shadow-lg`}
                                    style={{
                                      boxShadow: `0 0 20px rgba(0, 0, 0, 0.2), 0 0 40px ${
                                        colorScheme.icon.includes("cyan")
                                          ? "rgba(6, 182, 212, 0.3)"
                                          : colorScheme.icon.includes("blue")
                                          ? "rgba(59, 130, 246, 0.3)"
                                          : colorScheme.icon.includes("purple")
                                          ? "rgba(168, 85, 247, 0.3)"
                                          : colorScheme.icon.includes("pink")
                                          ? "rgba(236, 72, 153, 0.3)"
                                          : "rgba(16, 185, 129, 0.3)"
                                      }`,
                                    }}
                            ...
                            {index < 2 ? (
                                  ...
                                  <span
                                    className={`relative text-sm ${colorScheme.text} hover:text-white transition-colors font-semibold leading-relaxed`}
                                  >
                            {credential}
                          </span>
                ...
                {/* Contact/Social Links */}
                    ...
                    <motion.button
                      ...
                      onClick={() => {
                              window.open(
                                "https://www.linkedin.com/in/rodolfo-cristian-figueroa-portuguez-6973aa89/",
                                "_blank"
                              )
                            }}
        ...
        <FadeIn delay={1.1} className="mt-20 max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <motion.div
              ...
              style={{
                boxShadow:
                  "0 0 20px rgba(0, 0, 0, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.1)",
              }}
            >
              {/* Animated background glow */}
              <motion.div
              ...
              {/* Icon with enhanced styling */}
              <div
                className="relative flex-shrink-0 w-12 h-12 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-xl flex items-center justify-center hover:scale-110 transition-transform duration-300 shadow-lg"
                style={{
                  boxShadow:
                    "0 0 20px rgba(0, 0, 0, 0.2), 0 0 40px rgba(6, 182, 212, 0.3)",
                }}
              >
                <Briefcase className="w-6 h-6 text-white" />
              </div>
            ...
            >
              ...
              {/* Icon with enhanced styling */}
              <div
                className="relative flex-shrink-0 w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-500 rounded-xl flex items-center justify-center hover:scale-110 transition-transform duration-300 shadow-lg"
                style={{
                  boxShadow:
            ...
            >
              ...
              {/* Icon with enhanced styling */}
              <div
                className="relative flex-shrink-0 w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl flex items-center justify-center hover:scale-110 transition-transform duration-300 shadow-lg"
                style={{
                  boxShadow:
                    "0 0 20px rgba(0, 0, 0, 0.2), 0 0 40px rgba(168, 85, 247, 0.3)",
                }}
              >
